...
namespace otobusbiletotomasyonu
{
    public partial class Formum : MetroForm
    {
        ...
        private void button47_Click_1(object sender, EventArgs e)
        {
            ...
            groupBox7.Visible = false;
                if (b.Text == koltuk_no)
                {
                    ...
                    bay_Kadın_kontrol_et(koltuk_no,yolcu_cinsiyet);
                        if(oturabilir_mi)
                        {
                        ...
                        {
                            MessageBox.Show("Yan koltukta Kadın yolcu bulunmaktadır !");
                        }
        ...
        public void bay_Kadın_kontrol_et(string koltuk_kontrolu,string yolcu_cinsiyet)
        {
